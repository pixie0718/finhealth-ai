...
const Row = ({ k, v, color }) => (
  <div style={{ display: "flex", justifyContent: "space-between", gap: 12, padding: "6px 0", borderBottom: "1px solid #0f172a", fontSize: 12.5 }}>
    <span style={{ color: "#64748b" }}>{k}</span>
    <span style={{ color: color || "#e2e8f0", fontWeight: 600, textAlign: "right", wordBreak: "break-all" }}>{v}</span>
  </div>
);
...
export default function OcenModal({ ocen, onClose }) {
  ...
  return (
    <div onClick={(e) => e.target === e.currentTarget && onClose()} style={{
      ...
      <div style={{
        background: "#0b1220", border: "1px solid #334155", borderRadius: 20,
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <h2 style={{ fontSize: 20, fontWeight: 800, color: "#f1f5f9" }}>Submitted to IDBI Bank OCEN Node</h2>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 20, fontSize: 11.5, color: "#94a3b8" }}>
          <span style={{ background: "#1e293b", border: "1px solid #334155", padding: "6px 12px", borderRadius: 20 }}>📊 FinHealth AI</span>
          <span style={{ color: "#475569" }}>→</span>
          <span style={{ background: "#1e293b", border: "1px solid #334155", padding: "6px 12px", borderRadius: 20 }}>🔗 OCEN Node</span>
          <span style={{ color: "#475569" }}>→</span>
        ...
        <div style={{ background: `${dColor}12`, border: `1px solid ${dColor}44`, borderRadius: 14, padding: "16px 18px", marginBottom: 18 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontSize: 18, fontWeight: 800, color: "#f1f5f9" }}>{fmt(res.bankDecision.recommendedAmount)}</div>
            </div>
          </div>
        ...
        {/* request payload */}
        <div style={{ background: "#0f172a", border: "1px solid #1e293b", borderRadius: 12, padding: "14px 18px", marginBottom: 14 }}>
